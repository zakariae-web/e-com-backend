...
@method('PUT')
    ...
    <div class="row form-group">
        ...
        <div class="col-sm-6 input-column"><input type="text" name="name" id="name" class="p-2 shadow-sm form-control"value="{{old('name',$product->name)}}" required=""></div>
    </div>
    <div class="row form-group">
        <div class="col-sm-4 label-column"><label class="d-block mb-3 font-bold" for="email-input-field">price </label></div>
        <div class="col-sm-6 input-column"><input type="text" name="price" id="price" class="p-2 shadow-sm form-control" value="{{old('price',$product->price)}}" required=""></div>
    </div>
    <div class="row form-group">
        <div class="col-sm-4 label-column"><label class="d-block mb-3 font-bold">category </label></div>
        <div class="col-sm-6 input-column"><input type="text" name="category" id="category" class="p-2 shadow-sm form-control" value="{{old('category',$product->category)}}" required=""></div>
    </div>
    <div class="row form-group">
        <div class="col-sm-4 label-column"><label class="d-block mb-3 font-bold">review </label></div>
        <div class="col-sm-6 input-column"><input type="text" name="review" id="review" class="p-2 shadow-sm form-control" value="{{old('review',$product->review)}}"  required=""></div>
    </div>
    <div class="row form-group">

...
<html lang="en">
  ...
  <body>
    ...
    <main>
      ...
      <!-- LIVRAISON -->
      <div
        class="row bg-light container shadow-sm mx-auto my-5 text-center p-3"
      >
        <div
          class="col-md-3 d-flex justify-content-md-center mb-mds-4 align-items-center gap-3"
        >
      ...
      <div class="my-6 products">
        ...
        <div
          class="row container multiple-items text-center mx-auto d-flex justify-content-center my-5 align-items-center"
        >
          <!-- card 1 -->
          <div>
          ...
          <div>
            <div class="card shadow mx-2 p-4 mb-mds-4 mb-lgs-4">
              <div class="card-body text-center">
                <img
                  src="imgs/materials/clavier1.png"
                  alt="clavier"
                  class="img-fluid w-75 mx-auto"
                />
          ...
          <div>
            <div class="card shadow mx-2 p-4 mb-mds-4 mb-lgs-4">
              <div class="card-body text-center">
                <img
                  src="imgs/materials/headphone 1.png"
                  alt="headphone"
                  class="img-fluid w-75 mx-auto"
                />
          ...
          <div>
            <div class="card shadow mx-2 mb-mds-4 p-4 mb-mds-4 mb-lgs-4">
              <div class="card-body">
                <img
                  src="imgs/materials/mousepad1.png"
                  alt="mousepad"
                  class="img-fluid w-75 mx-auto"
                />
          ...
          <div>
            <div class="card shadow mx-2 mb-mds-4 p-4 mb-mds-4 mb-lgs-4">
              <div class="card-body">
                <img
                  src="imgs/materials/cart-mere1.png"
                  alt="motherboard"
                  class="img-fluid w-75 mx-auto"
                />
      ...
      <div id="discount" class="row container mx-auto my-4">
        ...
        <div class="col-md-6">
          <div class="mx-3 mid-pic">
            <img
              src="imgs/mid-pic1.png"
              alt="vr video game"
              class="img-fluid w-100 rounded mb-mds-4"
            />
            <a
              href=""
              class="custom__button2 rounded font-bold"
                  ...
                  <div class="modal-dialog mx-auto p-3">
                    <div class="modal-content">
                      <div class="modal-header shadow">
                        <h1
                          class="modal-title p-3 text-uppercase font-bold fs-5 main-clr"
      ...
      <div class="row container brands mx-auto my-6">
        ...
        <div class="">
          <div
            class="m-3 card__brands shadow d-flex flex-column align-items-center p-3 rounded"
          >
        ...
        <div>
          <div
            class="m-3 card__brands d-flex flex-column align-items-center shadow p-3 rounded"
          >
